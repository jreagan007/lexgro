...
**PPC lets you buy traffic immediately.** You control volume by controlling spend, but it is expensive. Use PPC for high-ROI practice areas where [case values justify the acquisition cost](/insights/pi-cost-per-lead-benchmarks/). Test carefully, because most firms overspend on PPC by not measuring cost-per-case correctly.
